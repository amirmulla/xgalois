 ...
 * @brief Examples for linear algebra operations over Galois fields using direct constructors
 */
...
int main() {
    ...
    // Matrix addition
    std::cout << "\n=== Matrix Addition ===\n";
    std::vector<std::vector<Element7>> sum_matrix(3, std::vector<Element7>(3, Element7(0, gf7_field)));
    ...
    std::cout << "\n=== Matrix Multiplication ===\n";
    std::vector<std::vector<Element7>> product_matrix(3, std::vector<Element7>(3, Element7(0, gf7_field)));
    ...
    std::vector<std::vector<Element2>> bin_product(2, std::vector<Element2>(2, Element2(0, gf2_field)));
    ...
    // Identity matrix
    std::cout << "\n=== Identity Matrix ===\n";
    std::vector<std::vector<Element7>> identity(3, std::vector<Element7>(3, Element7(0, gf7_field)));
    for (size_t i = 0; i < 3; ++i) {
    ...
    std::cout << "\nVerifying A * I = A:\n";
    std::vector<std::vector<Element7>> result(3, std::vector<Element7>(3, Element7(0, gf7_field)));
    ...
    std::cout << "All operations are performed in the respective finite fields.\n";
