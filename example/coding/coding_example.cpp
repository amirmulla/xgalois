...
void example_reed_solomon() {
  ...
  std::cout << "Error correction capability: "
            << ErrorCorrectionCapability(*rs_code) << std::endl;
  ...
  try {
    ...
    std::cout << "Decoding " << (success ? "successful" : "failed")
              << std::endl;
...
void example_generalized_reed_solomon() {
  ...
  std::cout << "Encoding/decoding test: " << (success ? "Passed" : "Failed")
            << std::endl;
...
void example_cyclic_code() {
  ...
  std::cout << "Generator polynomial degree: " << gen_poly.Degree()
            << std::endl;
...
void example_code_bounds() {
  ...
  std::cout << "  Is perfect: " << (IsPerfectCode(*rs_code) ? "Yes" : "No")
            << std::endl;
  std::cout << "  Is MDS: " << (IsMDS(*rs_code) ? "Yes" : "No") << std::endl;
