...
int main() {
    ...
    for (int trial = 0; trial < 3; ++trial) {
        ...
        std::cout << "Trial " << (trial + 1) << " - Errors: " << errors << std::endl;
    }
    ...
    xt::xarray<PrimeElementType> prime_message = xt::empty<PrimeElementType>({message_length});
    ...
    auto qsc = channels::CreateQarySymmetricChannel(gf31, message_length, error_prob);
