 ...
 * @brief Examples for extension field operations using GFPX alias and direct constructors
 */
...
int main() {
    ...
    std::cout << "================================\n";
    std::cout << "This example uses GFPX alias and direct constructors (NO factory)\n";
    ...
    std::cout << "  Order: " << gf9_field->Order() << ", Characteristic: " << gf9_field->Characteristic() << "\n";
    ...
    std::cout << "  Order: " << gf25_field->Order() << ", Characteristic: " << gf25_field->Characteristic() << "\n";
    ...
    std::cout << "  Order: " << gf49_field->Order() << ", Characteristic: " << gf49_field->Characteristic() << "\n";

    // Demonstrate working with polynomial elements
    std::cout << "\n=== Extension Field Elements (Polynomials) ===\n";
    std::cout << "Elements in extension fields are polynomials over the base field.\n";
    std::cout << "For example, in GF(3^2), elements are polynomials a₀ + a₁x where a₀, a₁ ∈ GF(3).\n";

    // Create polynomial elements using field methods
    std::cout << "\n=== Creating Polynomial Elements ===\n";
    std::cout << "In extension fields, we work with polynomial elements created through field operations.\n";
    ...
    std::cout << "  Irreducible polynomial: " << gf9_field->ToString(gf9_field->Modulus()) << "\n";
    ...
    std::cout << "Note: Primitive element computation is not implemented in this version.\n";
    ...
    std::cout << "  Irreducible polynomial: " << gf25_field->ToString(gf25_field->Modulus()) << "\n";

    std::cout << "\nExtension field examples completed successfully!\n";
    std::cout << "Note: This example uses direct constructors and type aliases (NO factory).\n";
    std::cout << "Extension fields use polynomial arithmetic over the base field.\n";
