...
protected:
    ...
    void SetUp() override {
        field = std::make_shared<FieldType>(7);
    }
...
TEST_F(LinalgPrimeTest, RowEchelonForm) {
    ...
    //      [2, 4, 3, 1],
    //      [3, 6, 0, 5]]
    A(0, 0) = FieldElement(1, field); A(0, 1) = FieldElement(2, field); A(0, 2) = FieldElement(1, field); A(0, 3) = FieldElement(0, field);
    A(1, 0) = FieldElement(2, field); A(1, 1) = FieldElement(4, field); A(1, 2) = FieldElement(3, field); A(1, 3) = FieldElement(1, field);
    A(2, 0) = FieldElement(3, field); A(2, 1) = FieldElement(6, field); A(2, 2) = FieldElement(0, field); A(2, 3) = FieldElement(5, field);
...
TEST_F(LinalgPrimeTest, MatrixRank) {
    ...
    //      [2, 4, 6]]
    // Rank is 1
    B(0, 0) = FieldElement(1, field); B(0, 1) = FieldElement(2, field); B(0, 2) = FieldElement(3, field);
    B(1, 0) = FieldElement(2, field); B(1, 1) = FieldElement(4, field); B(1, 2) = FieldElement(6, field);
