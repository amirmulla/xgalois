 ...
 * @brief Comprehensive benchmark comparison between binary extension field implementations
 * Compares 4 different implementation classes across small, medium, and large field sizes
 */
...
const std::vector<uint8_t> MEDIUM_FIELD_DEGREES = {9, 10, 11, 12, 13, 14, 15, 16};
